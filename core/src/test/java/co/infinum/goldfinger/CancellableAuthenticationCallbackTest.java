...
public class CancellableAuthenticationCallbackTest {
    ...
    private AuthenticationCallback cancellableCallback;
    ...
    private AuthenticationCallback newInstance(Mode mode) {
        return new AuthenticationCallback(crypto, mode, "", callback);
    }
}
